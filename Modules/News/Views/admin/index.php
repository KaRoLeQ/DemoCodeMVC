...
<?= $this->section('title') ?><?=lang('News.news_title')?><?= $this->endSection('') ?>
...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?=lang('News.news_title')?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><?=anchor('/admin',lang('OvenCms.ovencms_dashboard'))?></li>
            <li class="breadcrumb-item active"><?=anchor('/admin/news',lang('News.news_title'))?></li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title"><?=anchor('admin/news/posts','<i class="fas fa-newspaper"></i> '.lang('News.posts_subheading'))?></h3>
            ...
            <div class="col-md-4">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title"><?=anchor('admin/news/categories','<i class="fas fa-tags"></i> '.lang('News.categories_subheading'))?></h3>
                        <div class="card-tools">
